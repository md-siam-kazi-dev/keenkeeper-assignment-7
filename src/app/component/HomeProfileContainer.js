  ...
  return (<> 
    ...
    {profils.length != 0 ?<div className="container-div grid grid-cols-1 sm:grid-cols-2 mb-20 lg:grid-cols-4 gap-3 mt-10">
        ...
        {profils.map(profile => {
            ...
            return (
                <Link href={`/friend/${profileLink}/${profile.id}`} key={profile.id} className="text-center shadow-md border border-gray-100 gap-1 sm:gap-2 xl:gap-4 py-6">
                    ...
                    <span className="mt-2 mb-3 text-xs text-gray-500">{profile.days_since_contact}d ago</span>
